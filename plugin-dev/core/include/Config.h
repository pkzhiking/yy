...
#define OUTPUT_HTML CURRENT_PROJS_DIR "/plugin-dev2/run-result/"
#define PROBLEM_CONFIG CURRENT_PROJS_DIR "/plugin-dev2/problem.config"
#define USER "huawei"
#define PASSWORD "huawei"
#define DATABASE "huawei"
